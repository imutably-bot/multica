...
#   curl -fsSL https://raw.githubusercontent.com/imutably-bot/multica/main/scripts/install.sh | bash
#
# Install CLI + provision self-host server:
#   curl -fsSL https://raw.githubusercontent.com/imutably-bot/multica/main/scripts/install.sh | bash -s -- --with-server
#
...
# Configuration
# ---------------------------------------------------------------------------
REPO_URL="https://github.com/imutably-bot/multica.git"
REPO_WEB_URL="https://github.com/imutably-bot/multica"  # without .git, for GitHub web APIs
...
run_default() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/imutably-bot/multica/main/scripts/install.sh | bash -s -- --with-server\n"
  printf "\n"
}
...
run_with_server() {
  ...
  printf "     curl -fsSL https://raw.githubusercontent.com/imutably-bot/multica/main/scripts/install.sh | bash -s -- --stop\n"
  printf "\n"
}
